          ...
          {data.map((price, index) => (
            ...
            >
              ...
              <td className="px-6 py-4 break-all">
                {price.product || <span className="italic text-gray-400">N/A</span>}
              </td>
              <td className="px-6 py-4 break-all">
                {(price.category || '').replace('%40', '@')}
              </td>
             <td className="px-6 py-4 break-all">
                {price.prices[0] || <span className="italic text-gray-400">N/A</span>}
              </td>
              <td className="px-6 py-4 break-all">
                {price.prices[1] || <span className="italic text-gray-400">N/A</span>}
              </td>
              <td className="px-6 py-4 break-all">
                {price.prices[2] || <span className="italic text-gray-400">N/A</span>}
              </td>
              <td className="px-6 py-4 break-all">
                {price.prices[3] || <span className="italic text-gray-400">N/A</span>}
              </td>
              <td className="px-6 py-4 break-all">
                {price.prices[4] || <span className="italic text-gray-400">N/A</span>}
              </td>
            </tr>
          ))}
        </tbody>
